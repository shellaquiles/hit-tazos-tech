...
- **Convención oficial de nombres para imprenta**: Archivos versionados directos (`hit-tazos-tech-v1.0.1-rc.1-tabloide.pdf`, `hit-tazos-tech-v1.0.1-rc.1-carta.pdf`, `hit-tazos-tech-v1.0.1-rc.1-super-tabloide.pdf`) y estructuración de pliegos SVG en `print/svg/{formato}/v{version}/`.
